...
ip="127.0.0.1"
kwargs={'ip':"127.0.0.1" , 'port': 5006, 'con_type': "server"}
server_thread=Thread(target=My_TCP.My_TCP(), args=("127.0.0.1",5007,"client"))
server_socket=server_thread.start()
client_socket=My_TCP.My_TCP("127.0.0.1",5007,"client")
